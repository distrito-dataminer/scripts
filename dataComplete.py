...
if replace:
    master_list = ddmdata.data_replace(master_list, slave_list, no_add=noAdd, id_type=id_type, dictkey='Site')
else:
    master_list = ddmdata.data_complete(master_list, slave_list, no_add=noAdd, id_type=id_type, dictkey='Site')
