...
tags = ['Santa Catarina', 'Florianópolis', 'Joinville', 'Blumenau', 'Chapecó', 'Itajaí', 'Criciúma', 'Jaraguá do Sul', 'Palhoça', 'Lages', 'Camboriú', 'Brusque', 'Tubarão', 'São Bento do Sul', 'Navegantes']
#tags = ['Blumenau']
output = []
